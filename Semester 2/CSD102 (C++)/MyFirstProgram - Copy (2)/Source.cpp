...
View student needs to reference a line in the file, defaults to first line(first student) currently
Update student needs to implement data change for grades

Add student needs to have incrementing student numbers

Data processing for grades need to be implemented to update class/student (check replace instead of writing over certain lines)
